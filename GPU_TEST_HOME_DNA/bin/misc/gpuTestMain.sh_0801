#!/bin/bash
#: Author: Andrew Zhang
#: Script name: testGPUMain.sh 
#: Reviewers:
#: Date: 7/20/2016
#: Purpose:   Test GPU's comparison for the annotations files.
...
python $SNAIL_HOME/compare_snail_vs_ac_analysis.py \
    ...
    --ref $RUN_LOC/$STATION_NAME/$RUN_NAME/P_$4*/annotations.h5 \
...
echo ""
echo "And the png + csv files are at: `echo $GPU_TEST_HOME/result/$1/$3`"
echo "============================================================================================="
cd $GPU_TEST_HOME/result/$1/$3
echo ""
ls -l
echo " "

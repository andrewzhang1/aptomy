...
if __name__ == "__main__":
    ...
    # Get average length of over all tweets
    print("Average length of over all tweets: ", np.mean(df['len']))  # 109.35

    # Get the number of like for the most liked tweet
    print("Most liked tweet: ", np.max(df['likes'])) # 100685

    # Get the nm
    print("Retweets: ", np.max(df['retweets']))  # 100685

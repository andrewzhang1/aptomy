...
# Script name: employee1d_UseClassMethodAsAlternativeConstructor.py
'''
...
# provide multiple ways of creating our objects
# Use Cases:
...
fist, last, pay = emp_str_1.split('-')
#new_emp_1 = Employee(fist, last, pay)

...
public class HighLow {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            playAgain = Boolean.valueOf(scanner.nextLine().equals("Y")?"true":"false");
        } while (playAgain);
    ...
    private static int play() {
        ...
        Card nextCard;   // The next card in the deck.  The user tries to predict higher or lower.
        int correctGuesses ;  // The number of correct predictions.
        char guess;   // The user's guess.  'H' or 'L'.

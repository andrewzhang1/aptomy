...
##############################################################################
#
# Script Name: installer_beckett.sh
# Script Duty: Installs ESB, EDS, EAS, and SVP Beckett builds. 
# Author: Tuan M. Mai
# Date: 05/05/2006
#
##############################################################################
...
if [ "$INSTALL_PRODUCT" = "ESB" ] ; then
	ESB_BUILD=$BUILD_ROOT/essbase/builds/beckett/$INSTALL_BUILD/install/$ESB_INSTALL_OSP
...
if [ "$INSTALL_PRODUCT" = "EAS" ] ; then
	EAS_BUILD=$BUILD_ROOT/EAS/builds/beckett/$INSTALL_BUILD/install/$INSTALL_OSP
...
if [ "$INSTALL_PRODUCT" = "APS" ] ; then
        APS_BUILD=$BUILD_ROOT/eesdev/aps/beckett/$INSTALL_BUILD/install/$INSTALL_OSP

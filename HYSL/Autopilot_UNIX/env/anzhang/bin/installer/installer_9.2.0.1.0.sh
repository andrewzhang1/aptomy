...
if [ "$INSTALL_PRODUCT" = "ESB" ] ; then
	...
	ESB_BUILD=$BUILD_ROOT/essbase/builds/9.2/9.2.0.1.0/$INSTALL_BUILD/cd/$INSTALL_OSP
...
if [ "$INSTALL_PRODUCT" = "EAS" ] ; then
	EAS_BUILD=$BUILD_ROOT/EAS/builds/9.2.0.1.0/$INSTALL_BUILD/install/$INSTALL_OSP	
...
if [[ "$INSTALL_PRODUCT" = "EDS" ]] ; then
	EDS_BUILD=$BUILD_ROOT/eesdev/eds/builds/9.2.0.1.0/$INSTALL_BUILD/install/$INSTALL_OSP
...
if [[ "$INSTALL_PRODUCT" = "SVP" ]] ; then
	SVP_BUILD=$BUILD_ROOT/eesdev/provider/builds/9.2.0.1.0/$INSTALL_BUILD/install/$INSTALL_OSP

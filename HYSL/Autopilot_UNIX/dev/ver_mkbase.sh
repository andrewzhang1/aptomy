...
# 01/05/2012 YK - Add version 11.1.2.2.100 dynamic base.
# 09/25/2013 YK - Add essbase.cfg, essbase.bak and essbase_######.bak to ignore pattern of BI/FA
# 11/18/2013 YK - Bug 17814317 - MK_BASEFILE.SH SHOULD DUMP APS, EAS AND STUDIO FOLDER ALSO.
...
case $1 in
	...
	*)
		case $AP_SECMODE in
			...
			# 	_VER_DIRCMP=".*\.log .*|.*\.LOG .*|.* -> .*"
				_VER_DIRCMP="^ARBORPATH/Uninstall.*|.*\.log |.*\.LOG |.*/ESSCMDQ|.*/ESSCMDG|^ARBORPATH/bin/ESSTESTCREDSTORE"
				_VER_DIRCMP="${_VER_DIRCMP}|^HYPERION_HOME/client/epm/Essbase/EssbaseRTC/bin/essbase.cfg"
				_VER_DIRCMP="${_VER_DIRCMP}|^ARBORPATH/bin/essbase_sso.cfg.replaced.by.opatch"
				_VER_DIRCMP="${_VER_DIRCMP}|^ARBORPATH/bin/essbase\.bak"	# Ignore essbase.bak
				_VER_DIRCMP="${_VER_DIRCMP}|^ARBORPATH/bin/essbase_.*\.bak"	# Ignore essbase_######.bak
				_VER_DIRCMP="${_VER_DIRCMP}|^ARBORPATH/bin/essbase\.cfg"	# Ignore essbase.cfg
		
				_VER_DIRLST="\$ESSBASEPATH" 
				_VER_DIRLST="$_VER_DIRLST \$ARBORPATH"
				_VER_DIRLST="$_VER_DIRLST \$HYPERION_HOME/client" 
				_VER_DIRLST="$_VER_DIRLST \$HYPERION_HOME/products/Essbase/EssbaseStudio" 
				_VER_DIRLST="$_VER_DIRLST \$HYPERION_HOME/products/Essbase/aps" 
				_VER_DIRLST="$_VER_DIRLST \$HYPERION_HOME/products/Essbase/eas" 
			...
			*)
				_VER_DYNDIR="^ARBORPATH/bin/.*"
				_VER_DYNDIR="$_VER_DYNDIR|^HYPERION_HOME/../ohs/.*"
				_VER_DYNDIR="$_VER_DYNDIR|^HYPERION_HOME/common/config/.*"
				_VER_DYNDIR="$_VER_DYNDIR|^HYPERION_HOME/common/epmstage/.*"
				_VER_DYNDIR="$_VER_DYNDIR|^HYPERION_HOME/common/epmstatic/.*"
				...
				_VER_DYNDIR="$_VER_DYNDIR|^HYPERION_HOME/common/EssbaseRTC/11.1.2.0/localized/.*"
				_VER_DYNDIR="$_VER_DYNDIR|^HYPERION_HOME/common/essbase-studio-sdk/.*"
				_VER_DYNDIR="$_VER_DYNDIR|^HYPERION_HOME/common/jlib/.*"
				_VER_DYNDIR="$_VER_DYNDIR|^HYPERION_HOME/common/raframeworkrt/.*"
				_VER_DYNDIR="$_VER_DYNDIR|^HYPERION_HOME/common/validation/.*"
				...
				# _VER_DIRLST="$_VER_DIRLST \$ESSBASEPATH"

...
export AP_DEF_SHABBR="$AP_DEF_DATPATH/shabbr.txt"
export AP_DEF_EMAILLIST="$AP_DEF_DATPATH/email_list.txt"
export AP_DEF_SCRIPTLIST="$AP_DEF_DATPATH/script_list.txt"
export AP_DEF_DMAPP="$AP_DEF_DATPATH/DMAPP.tar"
export AP_DEF_AGENTPORTLIST="$AP_DEF_DATPATH/agentport_list.txt"
export AP_DEF_SXRAGENTPORTLIST="$AP_DEF_DATPATH/sxragentport_list.txt"
export AP_DEF_IGNORESH="$AP_DEF_DATPATH/ignoresh.txt"
...
{
# PLATFORM LIST
_pl="win32 winamd64 aix aix64 hpux64 solaris solaris64 solaris.x64 linux linuxamd64 linuxx64exa"
	if [ $# -ne 0 ]; then
		_pl=" $_pl "
        	[ "${_pl##* $1 }" != "$_pl" ]  && echo $1
	else
